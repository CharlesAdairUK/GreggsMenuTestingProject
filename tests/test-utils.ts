...
export const test = base.extend<TestFixtures>({
  ...
  page: async ({ page }, use) => {
    await page.addInitScript(() => {
      document.cookie =
        'OptanonAlertBoxClosed=2025-09-22T20:04:18.204Z; path=/; domain=.www.greggs.com'
      document.cookie =
        'OptanonConsent=isGpcEnabled=1&datestamp=Mon+Sep+22+2025+21%3A04%3A18+GMT%2B0100+(British+Summer+Time)&version=202501.2.0&browserGpcFlag=1&isIABGlobal=false&consentId=03d484d7-cf64-4b22-b225-5cda68e603cf&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0003%3A0%2CC0004%3A0%2CC0002%3A0&hosts=H9%3A0&genVendors=&intType=2; path=/; domain=.www.greggs.com'
    })
